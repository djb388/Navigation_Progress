...
public class JumpPoint {
    ...
    int x,y,wx,wy;      // Coordinates of this JumpPoint and its waypoint.
    ...
    public JumpPoint(int xLoc, int yLoc, JumpPoint jp) {
        x = xLoc;
        y = yLoc;
        mapLast = new JumpPoint(jp.x, jp.y);
        wx = jp.wx;
        wy = jp.wy;
    }
    
    public JumpPoint(int xLoc, int yLoc) {
        x = xLoc;
        y = yLoc;
        wx = -1;
        wy = -1;
     ...
     */
    public JumpPoint(int xLoc, int yLoc, int s) {
        x = xLoc;
        y = yLoc;
        wx = -1;
        wy = -1;
     ...
     */
    public JumpPoint(int xLoc, int yLoc, int waypointX, int waypointY, int s) {
        x = xLoc;
        y = yLoc;
        wx = waypointX;
        wy = waypointY;
     ...
     * @param dir directionality of this jump point
     * @param dist distance traveled to this node
     * @param s heuristic f(n) = h(n) + g(n)
     */
    public JumpPoint(int xLoc, int yLoc, int waypointX, int waypointY, JumpPoint last, int dir, int dist) {
        x = xLoc;
        y = yLoc;
        wx = waypointX;
        wy = waypointY;
        ...
        direction = dir;
        distance = dist;
        score = Math.max(Math.abs(goal[0]-newNode[0]),Math.abs(goal[1]-newNode[1]))+distance;
     ...
     * NE = 1, SE = 3, SW = 5, NW = 7
     */
    public int directionTo(int x2, int y2) {
        int nextDirection;
    ...
    public boolean sameBranch(JumpPoint jp) {
        ...
        while (root != null && root.x != jp.x && root.y != jp.y) {
            root = root.mapLast;
        }
